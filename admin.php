...
<body>
		...
		<div class="container">
			<div class="row" style="margin-top: 10px;">
				<div class="col-sm-2 col-xs-4" style="margin-left: 0;">
					<a href="admin.php"><img class="img-size" src="images/cp.png"></a>
				</div>
	...
	<nav class="navbar navbar-expand navbar-dark bd-navbar" style="font-family: Comic Sans MS;">
		<ul class="navbar-nav">
    		<li class="nav-item">
	      		<a class="nav-link" href="admin/home.php"><svg class="bi bi-house-fill" align="center" width="2em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    		...
    		<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="admin/leave_application.php">Pending</a>
					<a class="dropdown-item" href="admin/leave_application_reviewed.php">Reviewed</a>
				</div>
			</li>
		    <li class="nav-item dropdown">
    			<a class="nav-link" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Late Entry</a>     			
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="admin/late_entry.php">Pending</a>
					<a class="dropdown-item" href="admin/late_entry_reviewed.php">Reviewed</a>
				</div>
			</li>
  		</ul>
	  	<ul class="navbar-nav ml-md-auto">
	  		<li class="nav-item">
	      		<a class="nav-link disabled" style="color: white;">Hello, Admin</a>
	    	</li>
	  		<li class="nav-item">
