		...
		<ul class="navbar-nav">
    		...
    		<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="casual_leave.php">Casual Leave</a>
					<a class="dropdown-item" href="half_day_leave.php">Halfday Leave</a>
					<a class="dropdown-item" href="paid_leave.php">Paid Leave</a>
					<a class="dropdown-item" href="medical_leave.php">Medical Leave</a>
					<a class="dropdown-item" href="work_leave.php">Work Leave</a>
				</div>
			</li>
		    <li class="nav-item">
