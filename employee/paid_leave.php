<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		header("location: paid_leave.php");
	}
?>
<!DOCTYPE html>
<html>
...
<body>
	<script type="text/javascript" src="../js/paid_leave_val.js"></script>
	<?php

		include 'employee_header_nav.php';

	?>
	<form name="paid_leave" method="POST" onSubmit="return paid_leave_val()" style="font-family: Comic Sans MS;">
		<br>
		<div class="row" >
