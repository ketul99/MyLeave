<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		header("location: half_day_leave.php");
	}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Half Day Leave</title>
...
<body>
	<script type="text/javascript" src="../js/half_day_leave_val.js"></script>
	<?php

		include 'employee_header_nav.php';

	?>
	<form name="half_day_leave" method="POST" onSubmit="return half_day_leave_val()" style="font-family: Comic Sans MS;">
		<br>
		<div class="row" >
			...
			<div class="col-sm-4">
				...
				<div style="margin: 5px 0px;">
						<label class="radio-inline" style="margin: 0px 5px;font-family: Comic Sans MS;"><input type="radio" name="session" value="Morning"> Morning</label>
						<label class="radio-inline" style="font-family: Comic Sans MS;"><input type="radio" name="session" value="Afternoon"> Afternoon</label>
					</div>
				<div class="form-group">
