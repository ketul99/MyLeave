<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		header("location: medical_leave.php");
	}
...
<body>
	<script type="text/javascript" src="../js/medical_leave_val.js"></script>
	<?php

		include 'employee_header_nav.php';

	?>
	<form name="medical_leave" method="POST" onSubmit="return medical_leave_val()" enctype="multipart/form-data" style="font-family: Comic Sans MS;">
		<br>
		<div class="row" >
